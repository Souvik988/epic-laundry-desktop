...
V4 requires line-level immutable tax snapshots (classification, SAC/HSN, taxable value, CGST/SGST/IGST/cess, rounding), effective-dated accountant-approved rules, supplier/store tax profiles, explicit place-of-supply evidence/override audit, and Indian financial-year invoice series.
