...
| Routes | Rider coordinator | stops, capacity, stage, exceptions | Route workload analytics now separates skipped-stop exceptions from completed stops; automated route capture complete, human review open |
