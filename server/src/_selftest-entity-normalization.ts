...
try {
  ...
  assert.equal(store.migrationStatus().at(-1)?.version, 34, 'catalogue visual, operational, and search migrations remain checksum-tracked at the current migration head');
