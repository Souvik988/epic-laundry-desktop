...
export const ENTITIES: EntityDef[] = [
  ...
  {
    name: 'laundry_report_export_job',
    label: 'Laundry Report Export Job',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'LRE-{#####}', example: 'LRE-00001' },
    fields: [
      { name: 'report_kind', type: 'text', required: true },
      { name: 'from_date', type: 'date' },
      { name: 'to_date', type: 'date' },
      { name: 'search', type: 'text' },
      { name: 'status', type: 'select', required: true, options: ['Queued', 'Running', 'Completed', 'Failed', 'Expired'] },
  ...
  {
    name: 'laundry_report_saved_view',
    label: 'Laundry Report Saved View',
    kind: 'master',
    module: 'laundry',
    naming: { series: 'LRV-{#####}', example: 'LRV-00001' },
    fields: [
      { name: 'view_name', type: 'text', required: true },
      { name: 'report_kind', type: 'text', required: true },
      { name: 'from_date', type: 'date' },
      { name: 'to_date', type: 'date' },
      { name: 'search', type: 'text' },
  ...
  {
    name: 'laundry_service_zone',
    label: 'Laundry Service Zone',
    kind: 'master',
    module: 'laundry',
    naming: { series: 'LZONE-{#####}', example: 'LZONE-00001' },
    fields: [
      { name: 'name', type: 'text', required: true },
      { name: 'code', type: 'text' },
      { name: 'active', type: 'check' },
  ...
  {
    name: 'laundry_rack_profile',
    label: 'Laundry Rack Profile',
    kind: 'master',
    module: 'laundry',
    naming: { series: 'LRACK-{#####}', example: 'LRACK-00001' },
    fields: [
      { name: 'name', type: 'text', required: true },
      { name: 'code', type: 'text' },
  ...
  {
    name: 'laundry_route_run',
    label: 'Laundry Route Run',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'LRUN-{FY}-{#####}', example: 'LRUN-26-00001' },
    fields: [
      { name: 'rider', type: 'link', target: 'laundry_rider', required: true },
      { name: 'route_date', type: 'date', required: true },
      { name: 'stage', type: 'select', required: true, options: ['Pickup', 'Delivery'] },
      { name: 'service_zone', type: 'text' },
      { name: 'route_start_time', type: 'text' },
      { name: 'minutes_per_stop', type: 'int' },
      { name: 'status', type: 'select', required: true, options: ['Planned', 'In Progress', 'Completed', 'Cancelled'] },
      { name: 'stop_count', type: 'int', required: true },
      { name: 'started_at', type: 'datetime' },
      { name: 'completed_at', type: 'datetime' },
      { name: 'notes', type: 'long_text' },
    ],
  ...
  {
    name: 'laundry_route_stop',
    label: 'Laundry Route Stop',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'RSTOP-{#####}', example: 'RSTOP-00001' },
    fields: [
      { name: 'route_run', type: 'link', target: 'laundry_route_run', required: true },
      { name: 'order', type: 'link', target: 'laundry_order', required: true },
      { name: 'sequence', type: 'int', required: true },
      { name: 'status', type: 'select', required: true, options: ['Planned', 'Completed', 'Skipped'] },
      { name: 'completed_at', type: 'datetime' },
  ...
  {
    name: 'laundry_hardware_receipt',
    label: 'Laundry Hardware Receipt',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'HWRC-{FY}-{#####}', example: 'HWRC-26-00001' },
    fields: [
      { name: 'kind', type: 'text', required: true },
      { name: 'operation', type: 'text', required: true },
      { name: 'status', type: 'select', required: true, options: ['Completed', 'Failed', 'Cancelled'] },
      { name: 'device', type: 'text', required: true },
      { name: 'source_entity', type: 'text' },
      { name: 'source_id', type: 'text' },
      { name: 'evidence', type: 'long_text', required: true },
      { name: 'evidence_hash', type: 'text', required: true },
      { name: 'recorded_at', type: 'datetime', required: true },
      { name: 'recorded_by', type: 'text', required: true },
    ],
    permissions: [{ role: 'admin', read: true, write: true }],
  },
  {
  ...
  {
    name: 'laundry_cash_shift',
    label: 'Laundry Cash Shift',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'LCS-{FY}-{#####}', example: 'LCS-26-00001' },
    fields: [
      { name: 'business_date', type: 'date', required: true },
      { name: 'register', type: 'text', required: true },
      { name: 'opening_cash', type: 'currency', required: true },
      { name: 'expected_cash', type: 'currency', readonly: true },
      { name: 'counted_cash', type: 'currency' },
      { name: 'variance', type: 'currency', readonly: true },
      { name: 'opened_at', type: 'datetime', required: true },
      { name: 'opened_by', type: 'text', required: true },
      { name: 'closed_at', type: 'datetime' },
      { name: 'closed_by', type: 'text' },
      { name: 'note', type: 'long_text' },
      { name: 'close_note', type: 'long_text' },
      { name: 'currency', type: 'text', required: true },
    ],
    permissions: [{ role: 'admin', read: true, write: true }],
  },
  {
    name: 'laundry_production_task',
    label: 'Laundry Production Task',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'LPT-{FY}-{#####}', example: 'LPT-26-00001' },
    fields: [
      { name: 'garment_unit', type: 'text', required: true },
      { name: 'order', type: 'link', target: 'laundry_order', required: true },
      { name: 'station', type: 'text', required: true },
      { name: 'kind', type: 'text', required: true },
      { name: 'status', type: 'select', required: true, options: ['Open', 'In Progress', 'Completed', 'Blocked', 'Cancelled'] },
      { name: 'priority', type: 'select', required: true, options: ['Normal', 'Urgent'] },
      ...
      { name: 'completed_at', type: 'datetime' },
      { name: 'completed_by', type: 'text' },
      { name: 'output_state', type: 'text' },
      { name: 'completion_note', type: 'long_text' },
    ],
    permissions: [{ role: 'admin', read: true, write: true }],
  },
  {
  ...
  {
    name: 'laundry_customer_consent',
    label: 'Laundry Customer Consent History',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'LCC-{#####}', example: 'LCC-00001' },
    fields: [
      { name: 'customer', type: 'link', target: 'party', required: true },
      { name: 'consent_type', type: 'select', required: true, options: ['marketing'] },
      { name: 'granted', type: 'check', required: true },
  ...
  {
    name: 'laundry_quality_claim',
    label: 'Laundry Quality Claim',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'LQC-{FY}-{#####}', example: 'LQC-26-00001' },
    fields: [
      { name: 'garment_unit', type: 'text', required: true },
      { name: 'order', type: 'link', target: 'laundry_order', required: true },
      { name: 'category', type: 'select', required: true, options: ['Stain', 'Damage', 'Missing', 'Rewash', 'Other'] },
      { name: 'severity', type: 'select', required: true, options: ['Low', 'Medium', 'High', 'Critical'] },
      { name: 'status', type: 'select', required: true, options: ['Open', 'Under Review', 'Resolved', 'Rejected'] },
      { name: 'description', type: 'long_text', required: true },
      { name: 'opened_at', type: 'datetime', required: true },
      { name: 'opened_by', type: 'text', required: true },
      { name: 'resolved_at', type: 'datetime' },
      { name: 'resolved_by', type: 'text' },
      { name: 'decision', type: 'select', options: ['Rewash', 'Damaged', 'Missing', 'Release', 'Reject'] },
      { name: 'resolution_note', type: 'long_text' },
    ],
    permissions: [{ role: 'admin', read: true, write: true }],
  },
  {
    name: 'laundry_customer_correction',
    label: 'Laundry Customer Correction',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'LCR-{FY}-{#####}', example: 'LCR-26-00001' },
    fields: [
      { name: 'customer', type: 'link', target: 'party', required: true },
      { name: 'order', type: 'link', target: 'laundry_order', required: true },
      { name: 'claim', type: 'link', target: 'laundry_quality_claim', required: true },
      { name: 'garment_unit', type: 'text', required: true },
      { name: 'decision', type: 'select', required: true, options: ['Rewash', 'Damaged', 'Missing', 'Release', 'Reject'] },
      { name: 'status', type: 'select', required: true, options: ['Issued'] },
      { name: 'summary', type: 'long_text', required: true },
      { name: 'customer_message', type: 'long_text', required: true },
      { name: 'issued_at', type: 'datetime', required: true },
      { name: 'issued_by', type: 'text', required: true },
    ],
    permissions: [{ role: 'admin', read: true, write: true }],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'contract_price', type: 'currency' },
      { name: 'price_paid', type: 'currency', required: true },
      { name: 'payment_mode', type: 'select', options: ['Pay Later', 'Cash', 'UPI', 'Card', 'Bank'] },
      { name: 'payment_status', type: 'select', options: ['Unpaid', 'Part Paid', 'Paid'] },
  ...
  {
    name: 'customer_package_payment',
    label: 'Customer Package Payment',
    kind: 'document',
    module: 'laundry',
    naming: { series: 'CPP-{#####}', example: 'CPP-00001' },
    fields: [
      { name: 'customer_package', type: 'link', target: 'customer_package', required: true },
      { name: 'customer', type: 'link', target: 'party', required: true },
      { name: 'payment_date', type: 'date', required: true },
      { name: 'amount', type: 'currency', required: true },
      { name: 'mode', type: 'select', required: true, options: ['Cash', 'UPI', 'Card', 'Bank'] },
      { name: 'reference', type: 'text' },
      { name: 'reason', type: 'long_text' },
    ],
    permissions: [{ role: 'admin', read: true, write: true }],
  },
  {
    ...
    fields: [
      ...
      { name: 'preferred_contact', type: 'select', options: ['Phone', 'WhatsApp', 'Email', 'None'] },
      { name: 'service_preferences', type: 'long_text' },
      { name: 'marketing_consent', type: 'check' },
      { name: 'marketing_consent_at', type: 'datetime' },
      { name: 'marketing_consent_by', type: 'text' },
