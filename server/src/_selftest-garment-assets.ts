...
try {
  ...
  store.withStoreScope(tenant, 'STORE-ASSET', () => { store.insertRow({ ...base, id: 'g-exact', entity: 'laundry_garment', data: { name: 'Shirt', category: 'tops', visual_key: 'foldedShirt', photo: '/ui/app/garments/lndry-folded-shirt-v3.png', active: true } }); store.insertRow({ ...base, id: 'g-shared', entity: 'laundry_garment', data: { name: 'Formal shirt', category: 'tops', visual_key: 'foldedShirt', active: true } }); store.insertRow({ ...base, id: 'g-bad', entity: 'laundry_garment', data: { name: 'Unknown', category: 'tops', active: true } }); });
