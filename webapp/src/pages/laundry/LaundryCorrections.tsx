...
export default function LaundryCorrections() {
  ...
  if (corrections.isLoading) return <VisualLoadingState title="Loading correction documents" detail="Reading immutable quality decisions and customer-facing evidence." />
