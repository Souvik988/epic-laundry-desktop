...
export default function LaundryOperationsHub() {
  return <section className="animate-in fade-in slide-in-from-bottom-2 duration-500">
    <div className="max-w-3xl">
      <p className="text-[10px] font-extrabold uppercase tracking-[.18em] text-[#39786f]">Laundry operations</p>
      <h1 className="mt-2 font-display text-3xl font-semibold tracking-[-.035em] text-[#17353c]">One route from counter to customer.</h1>
      <p className="mt-3 max-w-2xl text-sm leading-6 text-[#617178]">Every workstream below operates on the same local order, garment and event history. There is no separate manufacturing or projects product to reconcile.</p>
    </div>
